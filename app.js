...
function carregarClube(dados) {
    ...
    if (!container) {
        ...
        console.warn(
            "Container #clubeCards não encontrado."
        );
    ...
    if (
        ...
        console.warn(
            "Nenhum card encontrado em dados.clube.cards"
        );
    ...
    dados.clube.cards.forEach(
        cardDados => {
            ...
            // -------------------------------------------------
            // IGNORAR CARD COMPLETAMENTE VAZIO
            // -------------------------------------------------

            if (
                !cardDados.tituloPequeno &&
                !cardDados.titulo &&
                !cardDados.descricao
            ) {
            ...
            if (
                ...
                tituloPequeno.className =
                    "clube-card-titulo-pequeno";
